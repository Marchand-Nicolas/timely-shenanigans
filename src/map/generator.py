...
table = [
    { "src/assets/grass.png" : 15, "src/assets/fleur.png" : -9 , "src/assets/arbre.png" : -9},
...
def generate_map(seed: int, width: int, height: int, player_amount=2):
    ...
    Out: Liste d'assets
    """
    assets = [Asset((0, 0), "src/assets/fleur.png", None, 24) ]
    for y in range(10, width, 10):
        for x in range(10, height, 10):
            ...
            if valeur + modificateur >= 90:
                assets.append(Asset((x, y), "src/assets/fleur.png", None, 24))
                continue
